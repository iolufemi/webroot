    ...
    <script type="text/javascript">
        ...
        <div class="grid_10">
            <div class="box round first grid">
                <h2 class="_left">
                    Locations</h2>
                    <span class="headerlink"><?php echo anchor("locations/create","Add New"); ?></span>
                <div class="block">
                ...
                $this->customhelper->success($alert_message);
                    ...
                    foreach($query->result() as $row){ ?>
                        ...
                        if($i == 1){echo "even";} ?> gradeX">
							<td><?php echo $ii/*anchor("locations/create/$row->id",$row->id,array('title' => 'Edit') )*/;?></td>
							<td><?php echo anchor("locations/create/$row->id",$row->location,array('title' => 'Edit') );?></td>
							
						      <td><a href="<?php echo base_url("/locations/delete/$row->id"); ?>" class="btn-mini btn-black btn-cross" title="Delete"><span></span>Delete</a></td>
                        </tr>
